...
describe('ChkPnrStsApi', () => {
  ...
  it('should get the pnr status details out of html', () => {
    ...
    const actualRes = ChkPnrStsApi._extractPnrDetail(apiResponse);
...
color: rgba(215, 0, 0, 0.87);
    ...
    <div class='non-printable btn btn-primary btn-large' onclick='window.print();'>Print</div>
    <style>.heading_table_top{font-size:14px;}</style>
    <h5>
        <b>Train Number</b> :
        <a href="/train/16526">16526
            <span class='non-printable'>(Check Train Details)</span>
        </a>
    </h5>
    <h5>
        <b>Train Name</b> : KANYAKUMARI EXP
    </h5>
    <h5>
        <b>Boarding Date</b> : 18- 3-2016
    </h5>
    <h5>
        <b>From</b> :
        <a href="/station/KJM">KJM</a>
    </h5>
    <h5>
        <b>To</b> :
        <a href="/station/TCR">TCR</a>
    </h5>
    <h5>
        <b>Reserved Upto</b> :
        <a href="/train/16526">TCR</a>
    </h5>
    <h5>
        <b>Boarding Point</b> :
        <a href="/train/16526">KJM</a>
    </h5>
    <h5>
        <b>Class</b> : 3A
    </h5>
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <tr>
        <td>Total Booking Fare</td>
        <td>1700</td>
        <td></td>
    </tr>
    <tr>
        <td>Charting Status</td>
        <td> CHART NOT PREPARED </td>
        <td></td>
    </tr>
</table>

</br>PNR Status Details by
<a href='http://CheckPNRstatusIRCTC.in/'>http://CheckPNRstatusIRCTC.in/</a>
</br>
</br>
<div id="example5" class='non-printable'>
